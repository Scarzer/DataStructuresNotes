...
namespace main_savitch_3
{
    ...
    private:
        size_type m_currSize;  // Total size of the array
        size_type m_currLoc;   // Current index of array
        bool m_itemTruth;
        value_type sq[CAPACITY];
        void advanceArray(value_type array[], size_type ptrArray);
